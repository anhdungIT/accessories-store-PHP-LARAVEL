    ...
    <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                      <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="product.php">Danh mục 1</a></li>
                                <li><a href="product.php">Danh mục 2</a></li>
                                <li><a href="product.php">Danh mục 3</a></li>
                                <li role="separator" class="divider"></li>
                                <li><a href="product.php">Apple</a></li>
                                <li role="separator" class="divider"></li>
        ...
        <div class="container">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.654265573633!2d106.67334938226848!3d10.76110631466888!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752ee26a5a692d%3A0x667ecda5250e5cee!2zMzggVHLhuqduIE5ow6JuIFTDtG4sIFBoxrDhu51uZyAyLCBRdeG6rW4gMTAsIEjhu5MgQ2jDrSBNaW5oLCBWaWV0bmFt!5e0!3m2!1sen!2s!4v1545874704585" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="row">
                    <h3>Tên công ty : Công ty ABC - XYZ</h3>
                    <p>Địa chỉ : 123/4 Hoàng hoa thám,quận 10,TPHCM</p>
                    <p>Phone : 0936771523</p>
                    <p>Mạng xã hội : Zalo : 0936771523</p>
                </div>
                <div class="col-md-5">
                    ...
                    <form>
                        ...
                        <button class="btn btn-default" type="submit" name="button">
                            <i class="glyphicon glyphicon-arrow-right" aria-hidden="true"></i> Gửi
                        </button>
                    </form>
