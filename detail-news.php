            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Danh mục tin</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Tiêu đề tin tức</li>
                    </ol>
                </nav>
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <h4 class="tieudetin">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h4>
                        <p class="noidungtin">
                ...
                <ul class="tinlienquan">
                    <li><a href="#">Tin liên quan với bài viết này</a></li>
                    <li><a href="#">Tin liên quan với bài viết này</a></li>
                    <li><a href="#">Tin liên quan với bài viết này</a></li>
                    <li><a href="#">Tin liên quan với bài viết này</a></li>
                    <li><a href="#">Tin liên quan với bài viết này</a></li>
