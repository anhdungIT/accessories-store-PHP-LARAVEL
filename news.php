            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Danh mục tin</li>
                    </ol>
                </nav>
                <div class="row row-tin">
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <img src="images/GodOfWar_Slider.jpg" width="100%">
                    </div>
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        <h4 class="tieude-tin"><a href="detail-news.php">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</a></h4>
                        <p class="tom-tat">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled</p>
                        <a href="#">Đọc tiếp...</a>
                    </div>
                </div>
                <div class="row row-tin">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        <h4 class="tieude-tin">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h4>
                        <p class="tom-tat">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled</p>
                        <a href="#">Đọc tiếp...</a>
                    </div>
                </div>
